...
package com.alibaba.otter.manager.biz.config.parameter.dal.mybatis;
...
/**
 * SystemParameter的DAO层，MyBatis 实现，提供配置持久化操作
 * 
 * @author sarah.lij 2012-4-13 下午04:57:52
 */
public class MyBatisSystemParameterDAO extends SqlSessionDaoSupport implements SystemParameterDAO {

    public SystemParameterDO insert(SystemParameterDO systemParameter) {
        Assert.assertNotNull(systemParameter);
        getSqlSession().insert("com.alibaba.otter.manager.biz.config.parameter.dal.dataobject.SystemParameterDO.insertParameter", systemParameter);
    ...
    public List<SystemParameterDO> listAll() {
        return getSqlSession().selectList("com.alibaba.otter.manager.biz.config.parameter.dal.dataobject.SystemParameterDO.listParameters");
    }
