...
/**
 * 类MyBatisDataColumnPairGroupDAO.java的实现描述：TODO 类实现描述
 * 
 * @author simon 2012-4-20 下午4:11:06
 */
public class MyBatisDataColumnPairGroupDAO extends SqlSessionDaoSupport implements DataColumnPairGroupDAO {

    public DataColumnPairGroupDO insert(DataColumnPairGroupDO entityObj) {
        Assert.assertNotNull(entityObj);
        getSqlSession().insert("com.alibaba.otter.manager.biz.config.datacolumnpair.dal.dataobject.DataColumnPairGroupDO.insertDataColumnPairGroup", entityObj);
        return entityObj;
    }
    ...
    public void deleteByDataMediaPairId(Long dataMediaPairId) {
        ...
        getSqlSession().delete("com.alibaba.otter.manager.biz.config.datacolumnpair.dal.dataobject.DataColumnPairGroupDO.deleteDataColumnPairGroupByDataMediaPairId", dataMediaPairId);
    ...
    public List<DataColumnPairGroupDO> ListByDataMediaPairId(Long dataMediaPairId) {
        Assert.assertNotNull(dataMediaPairId);
        List<DataColumnPairGroupDO> dataColumnPairGroupDos = getSqlSession().selectList("com.alibaba.otter.manager.biz.config.datacolumnpair.dal.dataobject.DataColumnPairGroupDO.listDataColumnPairGroupByDataMediaPairId",
                                                                                                    dataMediaPairId);
    ...
    public List<DataColumnPairGroupDO> ListByDataMediaPairIds(Long... dataMediaPairIds) {
        ...
        List<DataColumnPairGroupDO> dataColumnPairGroupDos = getSqlSession().selectList("com.alibaba.otter.manager.biz.config.datacolumnpair.dal.dataobject.DataColumnPairGroupDO.listDataColumnPairGroupByDataMediaPairIds",
                                                                                                    dataMediaPairIds);
        return dataColumnPairGroupDos;
    }
