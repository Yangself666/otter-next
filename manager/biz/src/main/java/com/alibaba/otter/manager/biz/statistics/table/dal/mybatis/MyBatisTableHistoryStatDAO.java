 ...
 */
public class MyBatisTableHistoryStatDAO extends SqlSessionDaoSupport implements TableHistoryStatDAO {

    @Override
    public void insertTableHistoryStat(TableHistoryStatDO tableHistoryStatDO) {
        getSqlSession().insert("com.alibaba.otter.manager.biz.statistics.table.dal.dataobject.TableHistoryStatDO.insertTableHistoryStat", tableHistoryStatDO);
    }
